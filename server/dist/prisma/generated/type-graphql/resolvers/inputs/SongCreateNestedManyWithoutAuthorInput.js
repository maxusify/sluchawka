...
exports.SongCreateNestedManyWithoutAuthorInput = void 0;
...
let SongCreateNestedManyWithoutAuthorInput = class SongCreateNestedManyWithoutAuthorInput {
};
__decorate([
...
], SongCreateNestedManyWithoutAuthorInput.prototype, "create", void 0);
__decorate([
    TypeGraphQL.Field(_type => [SongCreateOrConnectWithoutAuthorInput_1.SongCreateOrConnectWithoutAuthorInput], {
        nullable: true
    }),
    __metadata("design:type", Object)
], SongCreateNestedManyWithoutAuthorInput.prototype, "connectOrCreate", void 0);
__decorate([
    TypeGraphQL.Field(_type => SongCreateManyAuthorInputEnvelope_1.SongCreateManyAuthorInputEnvelope, {
        nullable: true
    }),
    __metadata("design:type", Object)
], SongCreateNestedManyWithoutAuthorInput.prototype, "createMany", void 0);
__decorate([
    TypeGraphQL.Field(_type => [SongWhereUniqueInput_1.SongWhereUniqueInput], {
        nullable: true
    }),
    __metadata("design:type", Object)
], SongCreateNestedManyWithoutAuthorInput.prototype, "connect", void 0);
SongCreateNestedManyWithoutAuthorInput = __decorate([
    TypeGraphQL.InputType("SongCreateNestedManyWithoutAuthorInput", {
        isAbstract: true
    })
], SongCreateNestedManyWithoutAuthorInput);
exports.SongCreateNestedManyWithoutAuthorInput = SongCreateNestedManyWithoutAuthorInput;
//# sourceMappingURL=SongCreateNestedManyWithoutAuthorInput.js.map