...
let SongRelationsResolver = class SongRelationsResolver {
    async author(song, ctx) {
    ...
    async UserFavoriteSongs(song, ctx) {
        return (0, helpers_1.getPrismaFromContext)(ctx).song.findUnique({
            where: {
                id: song.id,
            },
...
__decorate([
    ...
    __metadata("design:paramtypes", [Song_1.Song, Object]),
    __metadata("design:returntype", Promise)
], SongRelationsResolver.prototype, "author", null);
__decorate([
    ...
    __metadata("design:paramtypes", [Song_1.Song, Object]),
    __metadata("design:returntype", Promise)
], SongRelationsResolver.prototype, "UserFavoriteSongs", null);
SongRelationsResolver = __decorate([
    TypeGraphQL.Resolver(_of => Song_1.Song)
], SongRelationsResolver);
exports.SongRelationsResolver = SongRelationsResolver;
